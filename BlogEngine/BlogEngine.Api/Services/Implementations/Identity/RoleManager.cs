...
namespace BlogEngine.Api.Services.Implementations.Identity
{
    public class RoleManager : IRoleManager
    {
        ...
        public async Task<bool> IsCurrentUserAnEditor(int id)
        {
            var userRoles = (await GetUserRolesAsync(id));
            return userRoles.Any(x => x == UserRole.Editor);
        }

        public async Task<bool> IsCurrentUserAnAdmin(int id)
        {
            var userRoles = (await GetUserRolesAsync(id));
            return userRoles.Any(x => x == UserRole.Admin);
        }
